...
public class ObfuscatingRecursiveToStringStyle
{
    ...
    /**
     * This class is an extension of {@link RecursiveToStringStyle} but uses {@link ObfuscatingToStringBuilder} instead
    ...
    private static final class DefaultStyle extends RecursiveToStringStyle
    {
        ...
        public void appendDetail (StringBuffer buffer, String fieldName, Object value)
        {
            ...
            {
                buffer.append (ObfuscatingToStringBuilder.toString (value, this));
            }
            else
            {
     ...
     * This class also uses {@link ObfuscatingToStringBuilder} to build object strings.
     *
     * */
